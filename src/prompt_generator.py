...
class DeepSeekPromptGenerator:
    ...
    def generate_image_prompts(
        ...
        prompt_instruction = (
            f"You are a professional prompt engineer. I need you to create {num_prompts} detailed image generation prompts based on the following script content: "
...
def generate_prompts(
    ...
    api_client = DeepSeekAPIClient()
    prompt_generator = DeepSeekPromptGenerator(
        api_client,
        max_tokens=1000,
